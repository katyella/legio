...
describe("generateBash", () => {
	it("should return a bash completion script", () => {
		...
		expect(script).toContain("_legio()");
		expect(script).toContain("complete -F _legio legio");
...
describe("generateZsh", () => {
	it("should return a zsh completion script", () => {
		...
		expect(script).toContain("#compdef legio");
		expect(script).toContain("_legio()");
...
describe("generateFish", () => {
	it("should return a fish completion script", () => {
		...
		expect(script).toContain("complete -c legio");
...
describe("completionsCommand", () => {
	it("should write bash completion to stdout", () => {
		...
		try {
			...
			expect(output).toContain("_legio()");
			expect(output).toContain("complete -F _legio legio");
		} finally {
	...
	it("should write zsh completion to stdout", () => {
		...
		try {
			...
			expect(output).toContain("#compdef legio");
			expect(output).toContain("_legio()");
		} finally {
			process.stdout.write = originalWrite;
		}
	...
	it("should write fish completion to stdout", () => {
		...
		try {
			...
			expect(output).toContain("complete -c legio");
		} finally {
			process.stdout.write = originalWrite;
		}
	});
