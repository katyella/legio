/**
 * CLI command: legio errors [--agent <name>] [--run <id>] [--json] [--since <ts>] [--until <ts>] [--limit <n>]
 *
...
const ERRORS_HELP = `legio errors -- Aggregated error view across agents

Usage: legio errors [options]
...
/**
 * Entry point for `legio errors [--agent <name>] [--run <id>] [--json] [--since] [--until] [--limit]`.
 */
